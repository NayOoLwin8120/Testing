                            ...
                            <form method="POST" class="form-horizontal mt-3" action="{{ route('register') }}">
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        ...
                                        <x-text-input class="form-control block mt-1 w-full"
                            ...
                            <div class="form-group mb-3 row">
                                <div class="col-12">
                                      <!--  Password -->
                                        ...
                                        <x-text-input  class="form-control block mt-1 w-full"
                                        id="password"  type="password" name="password" :value="old('pasword')" required autofocus/>
                            ...
                            <div class="form-group mb-3 row">
                                <div class="col-12">
                                      <!--  Comfirm Password -->
                                        ...
                                        <x-text-input class="form-control block mt-1 w-full"
                                        id="password_confirmation" type="password" name="password_confirmation" :value="old('pasword')" required autofocus/>
