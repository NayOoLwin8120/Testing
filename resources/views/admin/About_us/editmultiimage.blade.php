...
<div class="main-content">
    ...
    <div class="page-content">
        <div class="card-body">
                ...
                <h1 class="card-title text-center mb-3">Edit  Multi Image</h1>

                <!-- end row -->
                <form action="{{route('admin.update_multiimage',$allmultiimage->id)}}" method="post" enctype="multipart/form-data">
                 @csrf
                    <div class="row mb-3">
