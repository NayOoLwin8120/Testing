                     ...
                     @endphp
                        <div class="dropdown d-inline-block user-dropdown">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="{{!empty($admindata->image)?url('admin/profileimage/'.$admindata->image):url('admin/no_image.jpeg')}}"
                                    alt="Header Avatar">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="{{route('admin.auth.changepassword')}}"><i class="ri-wallet-2-line align-middle me-1"></i>Change Password</a>
