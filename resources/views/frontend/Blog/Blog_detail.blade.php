...
@section('main')
@section('title')
BLog_detail | Personal Portfilio
@endsection
 <!-- main-area -->
        <main>
                                    ...
                                    <ul class="rc__post">
                                        ...
                                        <li class="rc__post__item">
                                            <div class="rc__post__thumb">
                                                <a href="{{route('blogdetail',$blog->id)}}"><img src="{{asset($blog->blog_image)}}" alt=""></a>
                                            </div>
                                            <div class="rc__post__content">
                                                <h5 class="title"><a href="{{route('blogdetail',$blog->id)}}">{{$blog->blog_title}}</a></h5>
