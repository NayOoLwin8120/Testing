                                        ...
                                        @foreach ($data as $item )
                                         <div class="portfolio__item">
                                            ...
                                            <div class="portfolio__overlay__content">
                                                ...
                                                <h4 class="title"><a href="portfolio-details.html">{{$item->portfilio_title}}</a></h4>
                                                <a href="{{route('admin.portfilio_detail',$item->id)}}" class="link">{{$item->portfilio_button}}</a>
                                            </div>
                                        </div>
                                        @endforeach
                                ...
                                <div class="col">
                                    <div class="portfolio__active">
                                        <div class="portfolio__item">
                                            ...
                                            <div class="portfolio__overlay__content">
                                                <span></span>
                                                <h4 class="title"><a href="portfolio-details.html"></a></h4>
                                                <a href="portfolio-details.html" class="link"></a>
                                            </div>
                                        </div>
                                        <div class="portfolio__item">
                                            <div class="portfolio__thumb">
