                                ...
                                <nav class="menu__nav">
                                    ...
                                    <div class="navbar__wrap main__menu d-none d-xl-flex">
                                        <ul class="navigation">
                                            ...
                                            <li class="menu-item-has-children {{ $route == 'allblogs' ? 'active' : ''}}"><a href="{{route('allblogs')}}">Our Blog</a>

                                            </li>
                                            <li class="{{ $route == 'contactme' ? 'active' : ''}}"><a href="{{route('contactme')}}">contact me</a></li>
                                        </ul>
                                    </div>
                                    <div class="header__btn d-none d-md-block">
                                        <a href="{{route('contactme')}}" class="btn">Contact me</a>
                                    </div>
                                </nav>
                            </div>
                            <!-- Mobile Menu  -->
