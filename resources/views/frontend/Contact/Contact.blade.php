                ...
                <div class="container">
                    <form action="{{route('store.message')}}" method="post" class="contact__form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="text" placeholder="Your Phonenumber*" name="phone">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="contact__info">
                                ...
                                <div class="contact__info__content">
                                    ...
                                    <span>{!!$alldata->footer->address!!}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="contact__info">
                                ...
                                <div class="contact__info__content">
                                    ...
                                    <span>{{$alldata->footer->phone_number}}</span>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="contact__info">
                                ...
                                <div class="contact__info__content">
                                    ...
                                    <span>{{$alldata->footer->email}}</span>
