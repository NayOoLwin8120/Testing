                            ...
                            <div class="breadcrumb__wrap__content">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">{{$portfilio->portfilio_title}}</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="services__details__thumb">
                                <img src="{{asset($portfilio->portfilio_image)}}"  alt="No Image">
                            </div>
                            <div class="services__details__content">
                                <h2 class="title">{{$portfilio->portfilio_title}}</h2>
                                <p>{!! $portfilio->portfilio_description !!}</p>
